...
(varjo:v-def-glsl-template-fun + (a) "~a" (:vec4) :vec4 :pure t)
(varjo:v-def-glsl-template-fun + (a) "~a" (:ivec2) :ivec2 :pure t)
(varjo:v-def-glsl-template-fun + (a) "~a" (:ivec3) :ivec3 :pure t)
(varjo:v-def-glsl-template-fun + (a) "~a" (:ivec4) :ivec4 :pure t)
(varjo:v-def-glsl-template-fun + (a) "~a" (:uvec2) :uvec2 :pure t)
(varjo:v-def-glsl-template-fun + (a) "~a" (:uvec3) :uvec3 :pure t)
(varjo:v-def-glsl-template-fun + (a) "~a" (:uvec4) :uvec4 :pure t)
(varjo:v-def-glsl-template-fun + (a) "~a" (:dvec2) :dvec2 :pure t)
(varjo:v-def-glsl-template-fun + (a) "~a" (:dvec3) :dvec3 :pure t)
(varjo:v-def-glsl-template-fun + (a) "~a" (:dvec4) :dvec4 :pure t)
(varjo:v-def-glsl-template-fun + (a b) "(~a + ~a)" (:vec2 :vec2) :vec2 :pure t)
(varjo:v-def-glsl-template-fun + (a b) "(~a + ~a)" (:vec3 :vec3) :vec3 :pure t)
(varjo:v-def-glsl-template-fun + (a b) "(~a + ~a)" (:vec4 :vec4) :vec4 :pure t)
(varjo:v-def-glsl-template-fun + (a b) "(~a + ~a)" (:ivec2 :ivec2) :ivec2 :pure t)
(varjo:v-def-glsl-template-fun + (a b) "(~a + ~a)" (:ivec3 :ivec3) :ivec3 :pure t)
(varjo:v-def-glsl-template-fun + (a b) "(~a + ~a)" (:ivec4 :ivec4) :ivec4 :pure t)
(varjo:v-def-glsl-template-fun + (a b) "(~a + ~a)" (:uvec2 :uvec2) :uvec2 :pure t)
(varjo:v-def-glsl-template-fun + (a b) "(~a + ~a)" (:uvec3 :uvec3) :uvec3 :pure t)
(varjo:v-def-glsl-template-fun + (a b) "(~a + ~a)" (:uvec4 :uvec4) :uvec4 :pure t)
(varjo:v-def-glsl-template-fun + (a b) "(~a + ~a)" (:dvec2 :dvec2) :dvec2 :pure t)
(varjo:v-def-glsl-template-fun + (a b) "(~a + ~a)" (:dvec3 :dvec3) :dvec3 :pure t)
(varjo:v-def-glsl-template-fun + (a b) "(~a + ~a)" (:dvec4 :dvec4) :dvec4 :pure t)
...
(varjo:v-def-glsl-template-fun * (a b) "(~a * ~a)" (:dvec3 :dvec3) :dvec3 :pure t)
(varjo:v-def-glsl-template-fun * (a b) "(~a * ~a)" (:dvec4 :dvec4) :dvec4 :pure t)
(varjo:v-def-glsl-template-fun * (a b) "(~a * ~a)" (:float :vec2) :vec2 :pure t)
(varjo:v-def-glsl-template-fun * (a b) "(~a * ~a)" (:float :vec3) :vec3 :pure t)
(varjo:v-def-glsl-template-fun * (a b) "(~a * ~a)" (:float :vec4) :vec4 :pure t)

(varjo:v-def-glsl-template-fun * (a b) "(~a * ~a)" (:vec2 :float) :vec2 :pure t)
(varjo:v-def-glsl-template-fun * (a b) "(~a * ~a)" (:vec3 :float) :vec3 :pure t)
(varjo:v-def-glsl-template-fun * (a b) "(~a * ~a)" (:vec4 :float) :vec4 :pure t)
(varjo:v-def-glsl-template-fun * (a b) "(~a * ~a)" (:ivec2 :float) :ivec2 :pure t)
(varjo:v-def-glsl-template-fun * (a b) "(~a * ~a)" (:ivec3 :float) :ivec3 :pure t)
(varjo:v-def-glsl-template-fun * (a b) "(~a * ~a)" (:ivec4 :float) :ivec4 :pure t)
(varjo:v-def-glsl-template-fun * (a b) "(~a * ~a)" (:uvec2 :float) :uvec2 :pure t)
(varjo:v-def-glsl-template-fun * (a b) "(~a * ~a)" (:uvec3 :float) :uvec3 :pure t)
(varjo:v-def-glsl-template-fun * (a b) "(~a * ~a)" (:uvec4 :float) :uvec4 :pure t)
(varjo:v-def-glsl-template-fun * (a b) "(~a * ~a)" (:dvec2 :float) :dvec2 :pure t)
(varjo:v-def-glsl-template-fun * (a b) "(~a * ~a)" (:dvec3 :float) :dvec3 :pure t)
(varjo:v-def-glsl-template-fun * (a b) "(~a * ~a)" (:dvec4 :float) :dvec4 :pure t)
(varjo:v-def-glsl-template-fun * (a b) "(~a * ~a)" (:float :float) :vec2 :pure t)
(varjo:v-def-glsl-template-fun * (a b) "(~a * ~a)" (:float :float) :vec3 :pure t)
(varjo:v-def-glsl-template-fun * (a b) "(~a * ~a)" (:float :float) :vec4 :pure t)
...
(varjo:v-def-glsl-template-fun / (a) "(1 / ~a)" (:vec4) :vec4 :pure t)
(varjo:v-def-glsl-template-fun / (a) "(1 / ~a)" (:ivec2) :ivec2 :pure t)
(varjo:v-def-glsl-template-fun / (a) "(1 / ~a)" (:ivec3) :ivec3 :pure t)
(varjo:v-def-glsl-template-fun / (a) "(1 / ~a)" (:ivec4) :ivec4 :pure t)
(varjo:v-def-glsl-template-fun / (a) "(1 / ~a)" (:uvec2) :uvec2 :pure t)
(varjo:v-def-glsl-template-fun / (a) "(1 / ~a)" (:uvec3) :uvec3 :pure t)
(varjo:v-def-glsl-template-fun / (a) "(1 / ~a)" (:uvec4) :uvec4 :pure t)
(varjo:v-def-glsl-template-fun / (a) "(1 / ~a)" (:dvec2) :dvec2 :pure t)
(varjo:v-def-glsl-template-fun / (a) "(1 / ~a)" (:dvec3) :dvec3 :pure t)
(varjo:v-def-glsl-template-fun / (a) "(1 / ~a)" (:dvec4) :dvec4 :pure t)
...
(varjo:v-def-glsl-template-fun negate (a) "(-~a)" (:vec2) :vec2 :pure t)
(varjo:v-def-glsl-template-fun negate (a) "(-~a)" (:vec3) :vec3 :pure t)
(varjo:v-def-glsl-template-fun negate (a) "(-~a)" (:vec4) :vec4 :pure t)
(varjo:v-def-glsl-template-fun negate (a) "(-~a)" (:ivec2) :ivec2 :pure t)
(varjo:v-def-glsl-template-fun negate (a) "(-~a)" (:ivec3) :ivec3 :pure t)
(varjo:v-def-glsl-template-fun negate (a) "(-~a)" (:ivec4) :ivec4 :pure t)
(varjo:v-def-glsl-template-fun negate (a) "(-~a)" (:uvec2) :uvec2 :pure t)
(varjo:v-def-glsl-template-fun negate (a) "(-~a)" (:uvec3) :uvec3 :pure t)
(varjo:v-def-glsl-template-fun negate (a) "(-~a)" (:uvec4) :uvec4 :pure t)
(varjo:v-def-glsl-template-fun negate (a) "(-~a)" (:dvec2) :dvec2 :pure t)
(varjo:v-def-glsl-template-fun negate (a) "(-~a)" (:dvec3) :dvec3 :pure t)
(varjo:v-def-glsl-template-fun negate (a) "(-~a)" (:dvec4) :dvec4 :pure t)
