...
(varjo:v-def-glsl-template-fun + (a) "~a" (:mat3) :mat3 :pure t)
(varjo:v-def-glsl-template-fun + (a b) "(~a + ~a)" (:mat3 :mat3) :mat3 :pure t)
(varjo:v-def-glsl-template-fun + (a) "~a" (:mat4) :mat4 :pure t)
...
(varjo:v-def-glsl-template-fun
 negate (a) "(-~a)" (:mat3) :mat3 :pure t)

(varjo:v-def-glsl-template-fun
 negate (a) "(-~a)" (:mat4) :mat4 :pure t)
